  ...
  return (
    <div className={styles.registerContainer}>
      <form onSubmit={handleRegister} className={styles.registerForm}>
        ...
        <input type="tel" placeholder="Номер телефона" pattern="\+?\d{10,15}" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />
        ...
        {role !== "student" && <input type="text" placeholder="Ключ для доступа (roleKey)" value={roleKey} onChange={(e) => setRoleKey(e.target.value)} />}
